...
Note that atoms are represented using Fun objects, and that CSP
assignments are represented using function symbols with name "$" where the the
first argument is the name of the CSP variable and the second its value.)"},
