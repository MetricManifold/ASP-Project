...
#define CLASP_VERSION "2.2-TP (Rev. 38341)"
#endif
...
#define CLASP_SOLVE_OPTIONS CLASP_PARALLEL_SOLVE_OPTIONS
#else
#include "../clasp/shared_context.h"
#include "../clasp/solve_algorithms.h""
namespace Clasp { typedef Clasp::BasicSolveOptions SolveOptions; }
#define CLASP_SOLVE_OPTIONS CLASP_BASIC_SOLVE_OPTIONS
#endif
...
namespace Clasp {
	...
	public:
		...
		struct Summary {
			...
			bool                 optimum()      const { return sat() && complete() && optimize(); }
			uint64               models()       const;
			int                  optimize()     const;
