...
namespace Clasp {
	...
	public:
		...
		static Result create(Solver& s, const ShortRep&  rep, uint32 flags) { return create_prepared(s, prepare(s, rep.lits, rep.size, rep.info, clause_force_simplify, rep.lits), flags); }
