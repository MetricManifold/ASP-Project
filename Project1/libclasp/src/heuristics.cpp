...
#define BERK_MAX_DECAY 65534
	...
	/////////////////////////////////////////////////////////////////////////////////////////
	ClaspVmtf::ClaspVmtf(LitVec::size_type mtf, const HeuParams& params) : MOVE_TO_FRONT(mtf >= 2 ? mtf : 2) {
	...
	void ClaspVmtf::startInit(const Solver& s) {
		if (s.configuration().heuReinit) { score_.clear(); vars_.clear(); }
	...
	/////////////////////////////////////////////////////////////////////////////////////////
	ClaspVsids::ClaspVsids(double decay, const HeuParams& params)
